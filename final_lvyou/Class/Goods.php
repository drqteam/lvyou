...
class Scenic  {
  ...
  function update($id)  {
    $sql = "UPDATE Scenic SET ScenicName='" . $this->ScenicName . "',  ScenicDetail='" . $this->ScenicDetail . "',ImageURL='" . $this->ImageURL . "', Price='" . $this->Price . "',  Priority='" . $this->Priority . "' WHERE ScenicId=" . $id;
	//执行SQL语句
	$this->conn->query($sql);
  }
