...
?>
  ...
  <td align=center><a href="GoodsDelt.php?gid=<?PHP echo($row[0]); ?>" onClick="if(confirm('确定删除?')){return this.href;}return false;" target=_blank>删除</a></td>
  </tr>  
<?PHP
} 
if ($m==0)
{
  print "<tr><td align=center colspan=5>没有景点</td></tr>";
} 
?>
</table>   
</body>